...
function toggleFloatingTitle() {
    if (cosmicAITitle) { // Check if cosmicAITitle element exists
        if (isFloatingTitleEnabled) { // Check if floating title is enabled
            cosmicAITitle.classList.add('animate-float'); // Add animation class
        } else {
            cosmicAITitle.classList.remove('animate-float'); // Remove animation class
        }
    }
}
